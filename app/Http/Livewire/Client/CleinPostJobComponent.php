...
class CleinPostJobComponent extends Component
{
    use WithFileUploads;
    ...
    public function render()
    {
        ...
        return view('livewire.client.clein-post-job-component', ['scategories'=>$scategories, 'services'=>$services, 'instruments'=>$instruments])->layout('layouts.admin');
    }
}
