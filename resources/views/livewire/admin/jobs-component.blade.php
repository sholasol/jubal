                                                    ...
                                                    <div class="job-listing-description">
                                                        ...
                                                        <div class="job-listing-footer">
                                                            ...
                                                            <div class="buttons-to-right always-visible">
                                                                <a href="{{ route('admin.jobcandidate', ['job_id' =>$job->id]) }}" class="button ripple-effect"><i class="icon-material-outline-supervisor-account"></i> Manage Candidates <span class="button-info">0</span></a>
                                                            </div>
                                                        </div>
                                                    </div>  
                                                </div>  
