        ...
        <div class="full-page-content-container" data-simplebar>
            <div class="full-page-content-inner">
                ...
                <div class="notify-box margin-top-15">
                    <div class="switch-container">
                        <label class="switch"><span class="switch-text">Jobs</span></label>
                    </div>
                    ...
                    <a href="#" class="job-listing">
                        ...
                        <div class="job-listing-details">
                            ...
                            <div class="job-listing-description">
                                <h4 class="job-listing-company">{{ $job->service_category }} <span class="verified-badge" title="Verified Employer" data-tippy-placement="top"></span></h4>
                        ...
                        <div class="job-listing-footer">
                            ...
                            <ul>
                                <li><i class="icon-material-baseline-mail-outline"></i> Apply Now</li>
