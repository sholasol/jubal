		...
		<div class="row"> 
			<div class="col-md-12">
				<div class="single-page-header-inner">
					<div class="left-side">
						<div class="header-image freelancer-avatar"><img src="{{ asset('asset/image/profiles') }}/{{ $profile->image }}" alt=""></div>
						<div class="header-details">
							<h3>{{ Auth::user()->name }} <span>{{ $profile->link }}</span></h3>
							<ul>
								<li><div class="star-rating" data-rating="5.0"></div></li>
								<li><img class="flag" src="{{ asset('images/flags/de.svg') }}" alt=""> {{ $profile->country }}</li>
