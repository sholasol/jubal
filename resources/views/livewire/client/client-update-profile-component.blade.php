                ...
                <div class="row">
                    ...
                    <div class="col-xl-12">
                        <div class="dashboard-box margin-top-0">
                            ...
                            <!-- Headline -->
                            <div class="headline">
                                <h3><i class="icon-material-outline-account-circle"></i> {{ Auth::user()->name }}</h3>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        @if ($newimage)
                                            ...
                                            @else
                                                <img src="{{ asset('asset/image/profiles') }}/{{ $image }}" width="120" alt="">
                                            @endif
                                        {{-- <div class="avatar-wrapper" data-tippy-placement="bottom" title="Change Avatar">
                                            <img class="profile-pic" src="{{ asset('images/user-avatar-placeholder.png') }}" alt="" />
                                            <div class="upload-button"></div>
                                            <input class="file-upload" type="file" wire:model="newimage" accept="image/*"/>
                                            @if ($newimage)
                                                <img src="{{ $newimage->temporaryUrl() }}" width="120" alt="">
                                            @else
                                                <img src="{{ asset('asset/image/profiles') }}/{{ $image }}" width="120" alt="">
